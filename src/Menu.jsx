...
import './index.css'
import Quotationlogic from "./Quotationlogic";

function Menu({ budgetProp }) {
    ...
    const handleCheckBoxSelected = (dataType) => {
        ...
        let URL = `https://server-faris-a02ca80e363b.herokuapp.com/dishes/` + `${dataType}`
    ...
    return (
        <div className="mt-8">
            <h1 className=" font-semibold text-lg ml-5 mb-3">Menu</h1>
            <div className="bg-red-100 p-10 ml-5 mr-5 mb-2">
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap mb-4 md:mb-0">
                        <div className="flex flex-col flex-wrap ml-8">
                            <div>
                                ...
                                <label
                                    className="ml-2 inline-block pl-[0.15rem] hover:cursor-pointer"
                        ...
                        <div className="flex flex-col ml-8">
                            <div>
                                <input
                                    ...
                                    onChange={() => handleCheckBoxSelected("South Indian Special")}
                                />
                                <label
                                    className="inline-block pl-[0.15rem] hover:cursor-pointer"
                                    htmlFor="checkboxDefault">
            ...
            <Quotationlogic messageFromParent={data} budgetValue={budgetProp} />
        </div>
